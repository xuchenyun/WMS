...
namespace Query.UI
{
    public partial class Form_CreateFinishDocEdit : Form
    {
        /// <summary>
        /// 单据类型
        /// </summary>
        ...
        BLL_MdcdatProduct bll_product = new BLL_MdcdatProduct();
        /// <summary>
        /// 扫描的数据源
        /// </summary>
        ...
        public Form_CreateFinishDocEdit()
        {
            InitializeComponent();
        ...
        private bool ValidateMaterialCode(out string msg)
        {
            ...
            //    return false;
            //}
            DataTable dt_product = bll_product.Select(string.Format(" ProductCode='{0}'", txtMaterialCode.Text.Trim()));
